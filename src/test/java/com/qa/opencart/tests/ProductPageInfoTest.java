...
public class ProductPageInfoTest extends BaseTest {
	...
	public void productInfoTest() {
		...
		//{Brand=Apple, Availability=In Stock, extaxprice=$2,000.00, Product Code=Product 18, productname=MacBook Pro, 
		...
		//extaxprice=$2,000.00, productname=MacBook Pro} - LinkedHashMap
